...
<svg :fill="color" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110 49">
    ...
    <path id="A" class="cls-1" d="M90.39,25.37H82.5l3.93-11ZM87.27,13H85.71L78.5,33h1.28L82,26.63h8.79L93.14,33H94.5L87.29,13.07Z" />
    <polyline id="N" class="cls-1" points="108.81 30.84 98.3 13 97 13 97 33 98.19 33 98.19 15.22 108.67 32.95 108.7 33 110 33 110 13 108.81 13 108.81 30.84" />
    <g id="L">
        <polygon id="I" class="cls-1" points="63 33 64 33 64 13 63 13 63 33" />
        <rect class="cls-1" x="63.5" y="32" width="11.96" height="1" />
    </g>
</svg>
</template>
<script>
